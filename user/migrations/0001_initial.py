# Generated by Django 3.1 on 2020-10-18 13:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.PositiveIntegerField(blank=True, choices=[(1, 'Umuahia'), (2, 'Aba')], null=True)),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Not Avaliable'), (2, 'Busy'), (3, 'Avaliable')], default=1)),
                ('journey_type', models.PositiveSmallIntegerField(choices=[(1, 'Within the city'), (2, 'InterCity travel')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, choices=[(1, 'Umuahia'), (2, 'Aba')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.PositiveSmallIntegerField(choices=[(1, 'Tricycle'), (2, 'Bus'), (3, 'Car')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Waiting for confirmation'), (2, 'Waiting for driver'), (3, 'Ongoing'), (4, 'Completed')], null=True)),
